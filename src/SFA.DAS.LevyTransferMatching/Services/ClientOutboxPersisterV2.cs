...
{
    private readonly NServiceBus.Services.IDateTimeService _dateTimeService;
    private readonly Func<DbConnection> _connectionBuilder;

    public ClientOutboxPersisterV2(NServiceBus.Services.IDateTimeService dateTimeService, ReadOnlySettings settings)
    {
